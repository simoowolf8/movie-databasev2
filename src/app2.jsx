...
return (
  <div className="relative min-h-screen bg-gray-100 flex flex-col items-center p-6">
    ...
    <button
          ...
          className="flex items-center px-1 py-1 bg-gray-200 rounded-full hover:bg-gray-300"
        >
        <img
          src="flags/us.png"
          alt="English"
      ...
      <button
          onClick={() => handleLanguageChange("fr")} // Change to fr
          className="flex items-center px-1 py-1 bg-gray-200 rounded-full hover:bg-gray-300"
        >
        <img
          src="flags/fr.png"
      ...
      <button
          onClick={() => handleLanguageChange("es")} // Change to English
          className="flex items-center px-1 py-1 bg-gray-200 rounded-full hover:bg-gray-300"
        >
        <img
          src="flags/es.png"
    ...
    <div className="absolute top-4 left-4">
      ...
      >
        {showFavorites ? t("back_to_search") : t("view_favorites")}
      </button>
    </div>
